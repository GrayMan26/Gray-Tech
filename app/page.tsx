  ...
  return (
    <>
      ...
      <section className="relative py-20 md:py-32 overflow-hidden">
        {/* Background Pattern */}
        <div className="absolute inset-0 bg-gradient-to-br from-[#0f0f0f] to-[#1a1a1a]">
          ...
          <div className="text-center space-y-8">
            ...
            <div className="flex justify-center mb-8">
              <div className="relative">
                ...
                {/* Floating icons */}
                <div className="absolute -top-2 -right-2 flex items-center justify-center w-8 h-8 bg-[#1e1e1e] rounded-full shadow-lg border border-gray-800">
                  <Monitor className="h-4 w-4 text-gray-300" />
                </div>
                <div className="absolute -bottom-2 -left-2 flex items-center justify-center w-8 h-8 bg-[#1e1e1e] rounded-full shadow-lg border border-gray-800">
                  <Printer className="h-4 w-4 text-gray-300" />
                </div>
                <div className="absolute top-1/2 -left-6 flex items-center justify-center w-6 h-6 bg-[#1e1e1e] rounded-full shadow-md border border-gray-800">
                  <Wifi className="h-3 w-3 text-gray-300" />
                </div>
                <div className="absolute top-1/2 -right-6 flex items-center justify-center w-6 h-6 bg-[#1e1e1e] rounded-full shadow-md border border-gray-800">
        ...
        <Container>
          <div className="space-y-12">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="text-center space-y-4 p-6 rounded-2xl bg-[#1e1e1e] border border-gray-800 shadow-sm">
